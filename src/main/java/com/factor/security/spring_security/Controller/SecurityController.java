...
//                        .requestMatchers(("factor/upload")).hasRole("ADMIN")
//                        .requestMatchers(("factor/get")).permitAll()
//                        .requestMatchers(("factor/get/{movie}")).permitAll()
//                        .requestMatchers(("factor/delete/{remove}")).hasRole("ADMIN")
//                        .anyRequest()
//                        .authenticated())
